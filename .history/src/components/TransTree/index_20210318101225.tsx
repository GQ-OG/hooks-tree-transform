            ...
            <Row gutter={24} justify="center" align="middle" style={{height: "100%"}}>
                ...
                <Col span={2}>
                    <div>   
                        ...
                        type="primary" 
                        onClick={() => {
                            console.log(leftTreesData?.leftKeys?.filter((item: any) => !rightTreesData?.keys?.includes(item)), "leftTreesData?.leftKeys?.filter((item: any) => !rightTreesData?.keys?.includes(item))")
                            // handleChangeRight({
                            ...
                            setLeftTreesData({
                                ...leftTreesData,
                                dataSource: formartDisableTrees(leftTreesData?.dataSource, leftTreesData?.leftKeys?.filter((item: any) => !rightTreesData?.keys?.includes(item)))
                            })
                        }}
                        icon={<LeftOutlined />} />
                    </div>
