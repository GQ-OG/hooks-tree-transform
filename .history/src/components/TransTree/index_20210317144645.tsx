                ...
                <Col span={11}>
                    ...
                    onCheck={(v: any, r: any) => {
                        ...
                        const afterLeftTrees = {
                            ...leftTreesData,
                            checked: v,
                            keys: r?.halfCheckedKeys?.concat(v),
                            selectDataSource: []
                        }
                        setLeftTreesData(handleChangeLeft(afterLeftTrees))
                    }}
                    />
                </Col>
                <Col span={2}>
                    <div>   
                        ...
                        onClick={() => {
                            setLeftTreesData({
                                ...
                                keys: [],
                                checked: [],
                                dataSource: formartDisableTrees(leftTreesData?.dataScource, leftTreesData?.keys)
                            })
                            setRightTreesData({
                                ...rightTreesData,
                                dataSource: leftTreesData?.selectDataSource
                            })
                            setStatus_left(false)
                        }}
                        icon={<RightOutlined />} />
                        <br />
                        <Button 
